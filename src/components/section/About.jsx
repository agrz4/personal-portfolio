...
export const About = () => {
    ...
    const backendSkills = ["Node.js", "Go", "PostgreSQL"]
        ...
        <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                    <li>
                        <strong>Bachelor's Degree in CS</strong> - UG (2022-2026)
                    </li>
                    <li>
                ...
                <div className="space-y-4 text-gray-300">
                    <div>
                        <h4 className="font-semibold">Software Engineer at ABC Corp (2023 - Present)</h4>
                        <p>
